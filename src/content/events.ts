...
export const events: EventItem[] = [
  {
    ...
    summary:
      "O Caiçara Experience colocou a tribo na areia para uma manhã de yoga, mini WOD, fotos, açaí e conexão de verdade com o estilo de vida do litoral.",
    highlights: [
      "Yoga ao nascer do sol com clima leve e acolhedor.",
      "Mini WOD adaptado para diferentes níveis de treino.",
      "Café da manhã, fotos e networking entre alunos e convidados.",
    ],
    heroImage: "/images/events/yoga/yoga-day-hero.jpg",
    gallery: [
      "/images/events/yoga/yoga-day-circle.jpg",
      "/images/events/yoga/yoga-day-details.jpg",
    ],
  ...
  },
  {
    ...
    summary:
      "O HD levou a energia do box para fora, com estações inspiradas em Hyrox, trenó, deslocamentos curtos e muita torcida para quem topou sair da rotina.",
    highlights: [
      ...
      "Comunidade reunida para experimentar força, fôlego e diversão no mesmo evento.",
    ],
    heroImage: "/images/events/hyrox/hyrox-day-hero.jpg",
    gallery: [
      "/images/events/hyrox/hyrox-day-portrait.jpg",
      "/images/events/hyrox/hyrox-day-team.jpg",
    ],
    ctaHref: siteConfig.instagramUrl,
  },
  {
    ...
    label: "Ritmo de comunidade",
    dateLabel: "26/04 | ativação especial",
    location: "São Vicente, com encontros na praia e no box",
    summary:
      "Entre a preparação no box e os encontros ao ar livre, a Caiçara também já puxou a energia da corrida com aulão coletivo e clima de 5KM para todo mundo participar.",
    highlights: [
      ...
      "Evento pensado para transformar corrida em experiência de grupo, não em pressão.",
    ],
    heroImage: "/images/events/corrida/corrida-day-hero.jpg",
    gallery: [
      "/images/events/corrida/corrida-day-training.jpg",
      "/images/events/corrida/corrida-day-community.jpg",
    ],
    ctaHref: siteConfig.instagramUrl,
  },
];
